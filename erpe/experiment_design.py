...
class EDesign_Ramsey(ExperimentDesignBase):
    def __init__(self, 
                 depths : List[int],
                 qids : str='Q0'):
        depths = depths
...
class EDesign_Xgate(ExperimentDesignBase):
    def __init__(self, 
                 depths : List[int],
                 qids : str='Q0'):
        depths = depths
...
class EDesign_Xoverrot(ExperimentDesignBase):
    def __init__(self, 
                 depths : List[int],
                 qids : str='Q0'):
        depths = depths
